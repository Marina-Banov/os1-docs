...
**Pitanje:** Zašto prvi C program ne ispisuje ništa sve dok se ne pokrene drugi C program? [HINT](https://www.cs.kent.edu/~ruttan/sysprog/lectures/shmem/pipes#named_pipe_read_write)
